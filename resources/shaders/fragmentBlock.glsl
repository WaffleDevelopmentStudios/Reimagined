...
void main() {
	vec4 shadedColor = texture(Texture, vec2(inTexCoord.x + (blockTypeToTexture(inBlockType, inBlockState, inBlockFace).x * 0.03125), inTexCoord.y + (blockTypeToTexture(inBlockType, inBlockState, inBlockFace).y * 0.03125)));
